[![DOI](https://zenodo.org/badge/doi/10.5281/zenodo.4687197.svg)](https://doi.org/10.5281/zenodo.4687197)

﻿# country dependent generic profile for each NUTS0 region for industry iron_and_steel (WP 2.7)
# generic typical day hourly profiles dependent on day-type and country for heat demand in the iron and steel industry
...
data/hotmaps_task_2.7_load_profile_industry_iron_and_steel_generic.csv  -- contains the dataset in CSV format
```

## Documentation


This dataset provides the hourly heat demand in the iron and steel industry for typical days. In this context we emphasize, that profiles are not measured but modelled taking into consideration factors amongst others shift work patterns, historical output per month/weekday. 
...
The datasets provided have to be interpreted as simplified indicator to enable the analysis that can be carried out within the Hotmaps toolbox. It should be noted that the results of the toolbox can be improved with recorded heat demand data of local representatives of the iron and steel industry.
